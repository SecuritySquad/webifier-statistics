...
names(fin.result) <- c('TLD','bedrohlich','verdächtig','sauber')
...
fin.result$TLD <- factor(fin.result$TLD, levels = unique(fin.result$TLD)[order(fin.result$bedrohlich, decreasing = TRUE)])
