...
result[result$overallResultType=='SUSPICIOUS',2] <- as.numeric(result[result$overallResultType=='SUSPICIOUS',2]) * 2
result[result$overallResultType=='MALICIOUS',2] <- as.numeric(result[result$overallResultType=='MALICIOUS',2]) * 5
result[,1] <- tld_extract(result[,1],NULL)[,2]
