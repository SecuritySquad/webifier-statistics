...
result$overallResultValue <- round(result$overallResultValue*100)
result[result$overallResultType=='SUSPICIOUS',2] <- result[result$overallResultType=='SUSPICIOUS',2]*2
result[result$overallResultType=='MALICIOUS',2] <- result[result$overallResultType=='MALICIOUS',2]*result[result$overallResultType=='MALICIOUS',2]
result[,1] <- tld_extract(result[,1],NULL)[,2]
