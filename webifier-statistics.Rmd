...
p <- ggplot(data = result, aes(x = TLD, fill = Ergebnis),col="Anzahl") +
            geom_bar(position = "dodge") +
            ylab("Anzahl") + 
  scale_fill_manual(values=c("red","grey","orange"))
ggplotly(p)
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'VirusScan'}", '{}',skip=0,limit=Inf)
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'PortScan'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'IpScan'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'PhishingDetector'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'HeaderInspection'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'LinkChecker'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'GoogleSafeBrowsing'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
...
### Getestete Seiten
```{r}
result <- dbGetQueryForKeys(mg1, 'webifierSingleTestResultData',"{name:'CertificateChecker'}", '{}',skip=0,limit=Inf)
valueBox(nrow(result), icon="fa-bar-chart")
```
